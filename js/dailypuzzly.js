function csoDailyPuzzle(e) { 
    ...
    var n = "https://www.chessstrategyonline.com/widgets/daily-puzzle/" + i + "/" + o + "?coords=" + s + "&width=" + (d - 20); 
    l.setAttribute("src", n), t.parentNode.replaceChild(l, t), window.addEventListener("resize", function () { var e = document.getElementById("csoDp"), t = e.offsetWidth; e.style.height = t + 60 + "px" }) } 
